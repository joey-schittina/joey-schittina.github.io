...
document.getElementById("finbut").onclick=function(){
document.getElementById("finbut").innerHTML='<img class="finny" src="IMG_3163.jpg" alt="finny picture">';
}

document.getElementById("magbut").onclick=function(){
